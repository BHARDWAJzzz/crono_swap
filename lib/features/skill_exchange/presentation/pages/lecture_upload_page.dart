...
class _LectureUploadPageState extends ConsumerState<LectureUploadPage> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              _buildTextField(_priceController, 'Price (in Hours)', Icons.timer_outlined, (v) {
  ...
  Widget _buildTextField(TextEditingController controller, String label, IconData icon, String? Function(String?)? validator, {int maxLines = 1, TextInputType? keyboardType}) {
